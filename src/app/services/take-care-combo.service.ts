...
const getAllTakeCareComboServiceByTech = async (status: TServicePkgStatus, technicianId: string, serviceCode?: string) =>{
    const params = { status, technicianId, serviceCode }
