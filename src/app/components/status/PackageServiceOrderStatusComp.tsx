...
interface PackageServiceOrderStatusCompProps{
    status: TPackageOrderStatus
}

const PackageServiceOrderStatusComp: React.FC<PackageServiceOrderStatusCompProps> = ({ status }) => {
    switch(status){
...
export default PackageServiceOrderStatusComp