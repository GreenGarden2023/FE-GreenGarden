...
const RevenueFour: React.FC<RevenueRenderProps> = ({ startDate, endDate }) => {
    ...
    useEffect(() =>{
        ...
        const init = async () =>{
            setLoading(true)
            try{
                const res = await revenueService.getRevenueFour(startDate, endDate)
                setData(res.data)
        ...
        <div className='rev-second'>
            {
                ...
                <>
                    <h1>Thống kê các cây bán nhiều nhất theo khoảng ngày ({oldDate[0]} - {oldDate[1]})</h1>
                                ...
                                <div className="rev-s-item" key={index}>
                                    ...
                                    <div className="rev-s-content">
                                        ...
                                        <p className="rev-s-quantity">
                                            Số lượng bán: {item.quantity} cây
                                        </p>
