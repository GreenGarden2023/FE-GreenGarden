...
export type PaymentActionType = 'detail' | 'deposit' | 'remaining' | 'extend' | 'return deposit' | 'assign' | 'accept service' | 'reject service' | 'update infor'  | 'create order' | 'cancel' | 'create calendar' | 'update calendar' |''
export type ServiceStatus = 'accepted' | 'rejected' | 'processing' | 'confirmed' | 'reprocess'
