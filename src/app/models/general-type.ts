...
export type OrderType = 'rent' | 'sale' | 'service' | 'request' | 'package' | 'combo' | '' 
...
export type TransactionType = 'rent deposit' | 'sale deposit' | 'service deposit' | 'rent payment' | 'sale payment' | 'service payment' | 'rent refund' | 'sale refund' | 'service refund' | 'compensation payment' | 'combo refund'
